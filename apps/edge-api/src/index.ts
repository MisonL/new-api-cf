...
import { createAssistantsRouter } from './routes/assistants';
...
import { createFineTuningRouter } from './routes/fine-tuning';
...
app.route('/', createAssistantsRouter());
app.route('/', createRunsRouter());
app.route('/', createThreadsRouter());
app.route('/', createModelRouter());
app.route('/', createFilesRouter());
app.route('/', createBatchesRouter());
app.route('/', createFineTuningRouter());
app.route('/', createVectorStoresRouter());
