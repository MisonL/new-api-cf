  ...
  router.get('/api/status', async (c) => {
    ...
    return ok(c, {
      ...
      endpoints: {
        ...
        openaiCompatible: ['/v1/files', '/v1/files/:fileId', '/v1/files/:fileId/content', '/v1/models', '/v1/audio/speech', '/v1/audio/transcriptions', '/v1/audio/translations', '/v1/chat/completions', '/v1/completions', '/v1/embeddings', '/v1/images/edits', '/v1/images/generations', '/v1/images/variations', '/v1/moderations', '/v1/responses']
      }
    });
  });
